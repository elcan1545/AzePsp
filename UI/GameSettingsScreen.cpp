...
void GameSettingsScreen::CreateGraphicsSettings(UI::ViewGroup *graphicsSettings) {
	...
	// AzePSP: AI Performans Modu — cihazin hardware-ina gore FPS/cozunurluk avtomatik optimallasdirmasi
	graphicsSettings->Add(new CheckBox(&g_Config.bAIPerformanceMode, gr->T("AI Performance Mode", "AI Performans Modu (AzePSP)")));
	graphicsSettings->Add(new SettingHint(gr->T("AIPerformanceMode Tip", "Cihazin hardware-ina gore FPS ve cozunurluyu avtomatik optimallasdirır"), nullptr));
